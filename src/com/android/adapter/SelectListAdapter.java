...
//		}
		...
		if (StringUtils.equalsIgnoreCase(bean.getFood_name(), Constants.SPLIT_LINE)) {
			...
			viewHolder.food_name.setTextSize(DisplayUtil.sp2px(context, 32));
			viewHolder.food_num.setTextSize(DisplayUtil.sp2px(context, 32));
			viewHolder.food_price.setTextSize(DisplayUtil.sp2px(context, 32));
			viewHolder.food_name.setText(bean.getFood_name());
		}
